import type { Candle, IndicatorConfig, SerializedDrawing, Theme, VisibleRange, Interval } from './contracts';
...
import type { PriceAxisAnnotation, LaidOutPriceAxisAnnotation, PriceAxisLineStyle } from './priceAxisTypes';
