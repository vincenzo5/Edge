...
| App module shell | `home/AppModuleShell.tsx` + `home/AppTopHeader.tsx` — full-height module routes with `HomeAppNav` rail + persistent content-column header (`edge` logo + global account picker) |
