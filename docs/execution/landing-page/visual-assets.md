...
| **[Inkpilot](https://inkpilot.dev/)** | VS Code extension + MCP | Interactive SVG editor with 14 tools. Built-in design prompts for logo, icon, badge, banner, graphic. Live preview, iterate by conversation | Yes | Free, open source | Assets 3.1–3.8 — best for custom icons. Can see what it's generating and iterate in real time |
