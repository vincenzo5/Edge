...
**Related:** [AI Tools Architecture (lib)](../../src/lib/ai/ARCHITECTURE.md), [Design System](../../src/lib/design-system/ARCHITECTURE.md), [Workspace State Persistence](./workspace-state-persistence-roadmap.md) (chat history deferred here), [Grok Copilot UX Parity](./grok-copilot-parity-roadmap.md) (shell/composer match grok.com — next UX track), [Quant Research Runtime](./quant-research-runtime-roadmap.md) (experiment compute outside the prompt), [Risk Management System](./risk-management-system-roadmap.md) (Phase 9 — Copilot RiskPolicy preview/compose vocabulary), [App-level Verification Wave 2](./app-level-verification-wave-2-roadmap.md), [Project Status](../PROJECT-STATUS.md), [Constraints](../CONSTRAINTS.md).
