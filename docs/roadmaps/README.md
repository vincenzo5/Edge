...
| Sub-harness tree | [sub-harness-tree-roadmap.md](./sub-harness-tree-roadmap.md) | Phase 0 **Passing** (2026-07-27); Phase 1 **Passing** (2026-07-27); Phase 2 **Passing** (2026-07-27); Phase 3 **Passing** (2026-07-27); Phase 4 **Pending** |
