...
| Comprehensive memory metrics | [memory-metrics-roadmap.md](./memory-metrics-roadmap.md) | Phase 0–2 **Passing** (2026-07-25); Phases 3–6 **Pending** — layered scorecard (heap, tab/process, GPU surfaces, desk composite, soak); measurement only |
| Runtime interaction performance | [runtime-performance-roadmap.md](./runtime-performance-roadmap.md) | Phase 0–1 **Passing** (2026-07-24); Phases 2–8 **Pending** — frame time / crosshair / tip tick / React wakeups |
