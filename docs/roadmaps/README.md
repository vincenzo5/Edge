...
| **App-level verification (Wave 2)** | [app-level-verification-wave-2-roadmap.md](./app-level-verification-wave-2-roadmap.md) | Phase 0 **Passing** (2026-07-24); Phases 1–4 **Pending** — post–Wave 1 Copilot / Connections / ops walks |
...
| Research UX (AI-first desk) | [research-ux-roadmap.md](./research-ux-roadmap.md) | Phases 0–7 **Passing** — Talk / Board / Desk; session reel; tiled Desk kept forever |
...
| Day classification | [day-classification-roadmap.md](./day-classification-roadmap.md) | Phase 1 **Passing** (2026-07-22); Phase 2+ cohort browse product open |
...
| Shared cache topology | [shared-cache-topology-roadmap.md](./shared-cache-topology-roadmap.md) | Phase 0–3 **Passing** (2026-07-24); Phase 4+ product open; manual redis health flip → Wave 2 Phase 4 |
...
| Code organization | [code-organization-roadmap.md](./code-organization-roadmap.md) | Phase 0 **Pending** — layering, god modules, components migration, chart shims, harness hygiene |
...
| Plan → execute token efficiency | [plan-execute-token-efficiency-roadmap.md](./plan-execute-token-efficiency-roadmap.md) | Phase 0–5 **Passing**; Phase 6 **Pending** — harness closeout helper |
