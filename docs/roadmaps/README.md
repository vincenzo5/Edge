...
| Local production containerization | [local-production-containerization-roadmap.md](./local-production-containerization-roadmap.md) | Phase 0–4 **Passing** (2026-07-26); Phase 5 **Pending** — cutover proof |
