...
| Persistent TWS sidecar | [persistent-tws-sidecar-roadmap.md](./persistent-tws-sidecar-roadmap.md) | Phase 0 **Passing**; Phases 1–5 **Pending** — Compose sidecar beside Gateways (dev + app-prod) |
