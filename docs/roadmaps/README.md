...
| Quant research runtime | [quant-research-runtime-roadmap.md](./quant-research-runtime-roadmap.md) | Phase 4 **Passing** (2026-07-30) — sandboxed Python cells via `run_research_code` |
