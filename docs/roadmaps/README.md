...
| Comprehensive memory metrics | [memory-metrics-roadmap.md](./memory-metrics-roadmap.md) | Phase 0–3 **Passing** (2026-07-25); Phases 4–6 **Pending** — layered scorecard (heap, tab/process, GPU surfaces, desk composite, soak); measurement only |
