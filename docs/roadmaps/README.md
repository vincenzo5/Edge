...
| Discord knowledge mine | [discord-knowledge-mine-roadmap.md](./discord-knowledge-mine-roadmap.md) | Phase 0 **Passing** (2026-07-29); Phase 1 **Passing** (2026-07-29); Phase 2 **Passing** (2026-07-30); Phase 3 **Passing** (2026-07-30) — priority channel extract; OPS side track (not Edge product) |
