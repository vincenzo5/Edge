...
| Production observability (free stack) | [production-observability-roadmap.md](./production-observability-roadmap.md) | Phase 0 **Passing**; Phases 1–5 **Pending** — probes, logs, durable audit/errors, free alerts |
