...
| Risk policy data model | [risk-policy-data-model-roadmap.md](./risk-policy-data-model-roadmap.md) | Phase 0 **Passing** (2026-07-30) — spine + apply UX intent frozen; Phase 1 **Passing** (2026-07-31) — Zod spine + helpers; Phase 2+ **Pending** |
...
| Discord knowledge mine | [discord-knowledge-mine-roadmap.md](./discord-knowledge-mine-roadmap.md) | Phase 0–11 **Passing** (2026-07-30) — track complete; refresh deferred; OPS side track |
