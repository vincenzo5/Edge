...
| Discord knowledge mine | [discord-knowledge-mine-roadmap.md](./discord-knowledge-mine-roadmap.md) | Phase 0–1 **Passing** (setup); Phase 2 **Passing** (2026-07-30) — Algo Trading, Coding full mine; Phase 3 **Pending** — next server; OPS side track (not Edge product) |
