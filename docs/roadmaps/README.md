...
| Trade management playbook | [trade-management-playbook-roadmap.md](./trade-management-playbook-roadmap.md) | Phase 0–3 **Passing** (2026-07-24); Phase 4 **Pending** — chart/OCO parity |
...
| Research UX (AI-first desk) | [research-ux-roadmap.md](./research-ux-roadmap.md) | Roadmap defined; Phase 0 **Pending** — Talk / Board / Desk; tiled Desk kept forever |
