...
| Quant research runtime | [quant-research-runtime-roadmap.md](./quant-research-runtime-roadmap.md) | Phase 0 **Passing** (2026-07-30) — contracts + architecture freeze |
...
| Discord knowledge mine | [discord-knowledge-mine-roadmap.md](./discord-knowledge-mine-roadmap.md) | Phase 0–1 **Passing** (setup); Phase 2 **Passing** — Algo; Phases 3–6 **Pending** — Trinity, Wolves, MarketLife, SMB; 3 servers omitted; OPS side track |
