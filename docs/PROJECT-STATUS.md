...
| App-level verification wave 2 — Phase 3 | Connections & provider preference walks 3.1–3.3 — Settings console, prefs → meta.source, displayName reload | **Active** | Harness activated 2026-07-24; app-level walks in progress on http://localhost:3003 | `docs/roadmaps/app-level-verification-wave-2-roadmap.md`, `ConnectionsSettingsSection.tsx`, `MarketDataSettingsSection.tsx`, `MarketDataConnectionMenu.tsx` |
...
- **Status:** Phase 0–5 **Passing** (2026-07-24)
...
- **Status:** **Active** (2026-07-24) — Connections & provider preference walks 3.1–3.3
...
- **Status:** **Active** (2026-07-24) — Phase 3 in progress
...
- **Blockers:** none
- **Next:** Close Phase 3 with quoted 3.1–3.3 evidence; then Phase 4.
