...
## Task Contract — Journal trade pace KPI

- **Status:** **Passing** (2026-08-06)
- **Goal:** Show observed closed-trade pace (`/wk` · `/mo`) on the account equity KPI for the active journal scope.
- **Delivered:** Pace math in `journalStats`; wired on Dashboard and Trades summary cards; scope denominators for Today/7d/30d/custom/All.
- **Verification:** **Focused:** `Test Files 2 passed (2)`, `Tests 73 passed (73)` — evidence `docs/evidence/journal-trade-pace-kpi-2026-08-06.txt`.
- **Blockers:** none
- **Next:** none
