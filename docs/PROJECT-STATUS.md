...
- **State:** **Active** — AI playbook tools (preview_playbook + attach_playbook)
- **Latest verification:** pending
- **Evidence:** `docs/evidence/trade-management-playbook-phase-7.txt`
- **Current blocker:** none
- **Next best step:** Run focused tests + build; harness closeout
...
| Trade management playbook — Phase 7 | Copilot preview_playbook + attach_playbook via TradingPort; public attachManagementPlaybook + preview/attach API | **Active** | pending | tradingService.ts, trading.ts, tradingPort.ts, playbooks/preview, playbooks/attach, confirmGate.ts, ai-tools-architecture.md |
...
| Research UX — Phase 8 | Opt-in research-default entry — default density pref, smart `/` redirect, home hub elevation | **Active** | pending | defaultDensityPreference.ts, rootRedirect.ts, lastModule.ts, entryPolicy.ts, RootEntryRedirect.tsx, AppSettingsShell.tsx, HomeHubCards.tsx, researchUxPhase8.test.ts |
