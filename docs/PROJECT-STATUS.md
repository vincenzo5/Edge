...
| App-level verification wave 2 — Phase 4 | Ops residuals walks 4.1–4.5 — Redis health flip, journal import/sync, MCP alerts, calm header | **Active** | pending | `docs/roadmaps/app-level-verification-wave-2-roadmap.md`, `docs/evidence/app-level-verification-wave-2-phase-4.txt` |
