...
## Task Contract — Task efficiency ledger

- **Status:** Phase 7 **Active**
- **Goal:** Centralized append-only efficiency ledger; closeout fails without valid row (messages, handoffs, rework, spend).
- **Delivered:** pending
- **Verification:** `npm test -- --run scripts/efficiency-ledger.test.ts scripts/harness-closeout.test.ts`; closeout gate smoke
- **Blockers:** none
- **Next:** focused verify → harness closeout → Phase 7 Passing
