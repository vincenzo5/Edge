...
## Task Contract — Journal capital baseline wiring

- **Status:** **Passing** (2026-08-06)
- **Goal:** Wire Journal Settings → Capital net deposits into Account equity $/% and max drawdown % starting base.
- **Delivered:** Prefer configured net deposits over inferred starting equity; dollar secondary = live equity − capital when both exist; Dashboard/Trades wired via `useJournalCapitalEvents`.
- **Verification:** **Focused:** `Test Files 2 passed (2)`, `Tests 77 passed (77)` — evidence `docs/evidence/journal-capital-baseline-wiring-2026-08-06.txt`.
- **Blockers:** none
- **Next:** Refresh Journal in prod after ship to confirm ~$8.65K / +30.9% vs $28k capital.
