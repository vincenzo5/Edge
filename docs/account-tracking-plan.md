...
Reference inventory: [docs/ib-api-account-data.md](./ib-api-account-data.md).
...
- **AI tool features**: out of scope v1 (no `get_account_summary` tool). Deferred to a later phase per [docs/ai-tools-architecture.md](../docs/ai-tools-architecture.md).
