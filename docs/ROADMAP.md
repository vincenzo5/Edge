...
- [Live functional QA remediation](./roadmaps/live-functional-qa-remediation-roadmap.md) — Phase 0–4 **Passing**; Phases 5–8 **Pending** (2026-07-28 live QA findings → React, persistence, broker poll, screener, perf, re-verify)
