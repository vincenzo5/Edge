...
| Local deployment | Host-native track complete; containerization Phase 3 **Passing** | Phases 0–5 of the dual-environment local deployment are Passing. Development remains host-native; containerization Phases 0–3 add lifecycle CLI + ownership guards over Compose app-prod. [Local Development and Production](./roadmaps/local-dev-production-roadmap.md) · [Local Production Containerization](./roadmaps/local-production-containerization-roadmap.md). |
