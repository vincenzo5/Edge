...
- [Comprehensive memory metrics](./roadmaps/memory-metrics-roadmap.md) — Phase 0–3 **Passing** (2026-07-25); Phases 4–6 **Pending** (desk composite, soak scorecard; measurement only)
