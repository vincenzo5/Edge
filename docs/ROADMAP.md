...
- [Comprehensive memory metrics](./roadmaps/memory-metrics-roadmap.md) — Phase 0–4 **Passing** (2026-07-25); Phases 5–6 **Pending** (scorecard report, soak; measurement only)
