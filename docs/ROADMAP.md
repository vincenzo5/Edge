...
| Risk management system | Phase 0 **Passing** (2026-07-29); Phase 1 **Passing** (2026-07-30); Phase 2 **Passing** (2026-07-29); Phase 3 **Passing** (2026-07-29); Phase 4 **Passing** (2026-07-29); Phase 5 **Passing** (2026-07-30); Phase 6 **Passing** (2026-07-30); Phase 7 **Passing** (2026-07-30); Phase 8 **Passing** (2026-07-30); Phase 9 **Passing** (2026-07-30); Phase 10 **Passing** (2026-07-30) | Shared **RiskPolicy** model + architecture spine; account day-loss / open-heat kills. [Risk Management System Roadmap](./roadmaps/risk-management-system-roadmap.md). |
| Risk policy data model | Phase 0 **Passing** (2026-07-30); Phase 1 **Passing** (2026-07-31); Phase 2+ **Pending** | Persisted Template / Instance spine + apply UX intent (chart policy / Trade entry+schedule); EntrySchedule first-class. [Risk Policy Data Model Roadmap](./roadmaps/risk-policy-data-model-roadmap.md). |
...
| Local deployment | Containerization Phase 5 **Passing** — track complete | Host-native dev + Docker prod is the supported local production path. [Local Production Containerization](./roadmaps/local-production-containerization-roadmap.md). Legacy worktree/LaunchAgent commands refuse after cutover. |
...
| **Dual connection (post-5)** | **Partial** | Display preference ≠ order account + shared sidecar env lock shipped; remaining credential-gated both-Gateway walk. [Dual Connection Roadmap](./roadmaps/dual-connection-roadmap.md) |
...
- Quantitative strategy R&D (experiments + compact results outside the prompt) → [Quant Research Runtime](./roadmaps/quant-research-runtime-roadmap.md).
...
- [Live functional QA remediation](./roadmaps/live-functional-qa-remediation-roadmap.md) — Phase 0–8 **Passing**; track complete (2026-07-28 live QA → React, persistence, broker poll, screener, perf, Wave 3 re-verify)
...
- [Risk policy data model](./roadmaps/risk-policy-data-model-roadmap.md) — Phase 0 **Passing** (2026-07-30) spine + apply UX intent; Phase 1 **Passing** (2026-07-31) Zod spine + helpers; Phase 2+ **Pending**
...
- [Sub-harness tree](./roadmaps/sub-harness-tree-roadmap.md) — Phase 0–5 **Passing** (2026-07-27); track complete
...
- [Risk Management System Roadmap](./roadmaps/risk-management-system-roadmap.md) - shared RiskPolicy slots; catalog filing; where Plan/Protect/Manage/Gates plug into the app.
- [Risk Policy Data Model Roadmap](./roadmaps/risk-policy-data-model-roadmap.md) - persisted Template / Instance spine; apply UX (chart / Trade / library); EntrySchedule; evolve playbook tables.
