...
| Risk management system | Phase 0 **Passing** (2026-07-29); Phase 1 **Passing** (2026-07-30); Phase 2 **Pending** | Shared **RiskPolicy** model + architecture spine; UX moments Phases 2–10 (chart draw → Risk sidebar → ticket → open → during → failure mode → journal → copilot → account kills). [Risk Management System Roadmap](./roadmaps/risk-management-system-roadmap.md). |
...
- [Risk management system](./roadmaps/risk-management-system-roadmap.md) — Phase 0 **Passing** (2026-07-29); Phase 1 **Passing** (2026-07-30); Phase 2 **Pending**; UX moments Phases 2–10 (draw → … → account kills)
...
- Discord knowledge mine — OPS side track (local MCP extract, not product); Phase 0 **Pending** → [Discord Knowledge Mine Roadmap](./roadmaps/discord-knowledge-mine-roadmap.md)
