...
- [Comprehensive memory metrics](./roadmaps/memory-metrics-roadmap.md) — Phase 0–2 **Passing** (2026-07-25); Phases 3–6 **Pending** (GPU surfaces, desk composite, soak scorecard; measurement only)
