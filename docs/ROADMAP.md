...
| Risk management system | Phase 0 **Passing** (2026-07-29); Phase 1 **Passing** (2026-07-30); Phase 2 **Passing** (2026-07-29); Phase 3 **Passing** (2026-07-29) | Shared **RiskPolicy** model + architecture spine; UX moments Phases 4–10 (Trade ticket → open → during → failure mode → journal → copilot → account kills). [Risk Management System Roadmap](./roadmaps/risk-management-system-roadmap.md). |
...
- [Risk management system](./roadmaps/risk-management-system-roadmap.md) — Phase 0 **Passing** (2026-07-29); Phase 1 **Passing** (2026-07-30); Phase 2 **Passing** (2026-07-29); Phase 3 **Passing** (2026-07-29); UX moments Phases 4–10 (Trade ticket → … → account kills)
