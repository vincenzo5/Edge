...
| Risk management system | Phase 0 **Passing** (2026-07-29); Phase 1 **Pending** | Shared **RiskPolicy** model frozen; UX moments Phases 2–10 (chart draw → Risk sidebar → ticket → open → during → failure mode → journal → copilot → account kills). [Risk Management System Roadmap](./roadmaps/risk-management-system-roadmap.md). |
...
- [Risk management system](./roadmaps/risk-management-system-roadmap.md) — Phase 0 **Passing** (2026-07-29); Phase 1 **Pending**; UX moments Phases 2–10 (draw → … → account kills)
