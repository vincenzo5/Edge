...
| Local deployment | Host-native track complete; containerization Phase 4 **Passing** | Phases 0–5 of the dual-environment local deployment are Passing. Development remains host-native; containerization Phases 0–4 add lifecycle CLI, ownership guards, and image deploy/rollback. [Local Development and Production](./roadmaps/local-dev-production-roadmap.md) · [Local Production Containerization](./roadmaps/local-production-containerization-roadmap.md). |
