...
- [Comprehensive memory metrics](./roadmaps/memory-metrics-roadmap.md) — Phase 0–1 **Passing** (2026-07-24); Phases 2–6 **Pending** (tab/process RSS, GPU surfaces, desk composite, soak scorecard; measurement only)
