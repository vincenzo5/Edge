...
| Local deployment | Phase 0 **Passing** | Deployment constants, paired-profile preflight/status CLI, and isolated environment contract are frozen; shared Docker infrastructure starts in Phase 1. [Local Development and Production Roadmap](./roadmaps/local-dev-production-roadmap.md). |
